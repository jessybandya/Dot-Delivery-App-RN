...
import FInput from '../../../components/Container';
...
const Orders = ({ navigation }) => {
  ...
  const renderListFooter = () => (
    <Padding paddingBottom={bottom + 80}>
      <Observer>
        {() => foodData && <ActivityIndicator style={{ marginTop: 100 }} size="large" color={COLORS.primary} />}
      </Observer>
    </Padding>
  );
  const renderRestaurantListFooter = () => (
    <Padding paddingBottom={bottom + 80}>
      <Observer>
        {() => restaurantData && <ActivityIndicator style={{ marginTop: 100 }} size="large" color={COLORS.primary} />}
      </Observer>
    </Padding>
  );
  return (
      ...
      <View style={styles.mainContainer}>
        <View style={styles.tabSwitcher}>
          <Pressable onPress={() => onTabPress(0)} style={styles.tab}>
            <Animated.Text style={[styles.tabName, tab1NameStyle]}>Menus</Animated.Text>
          </Pressable>
                ...
                <FlatList
                  ...
                  ListHeaderComponent={() => (
                    <View style={styles.searchResult}>
                      ...
                      <FText fontSize="h4">{`${foodData.length}`} Results</FText>
                    </View>
                  )}
              ...
              {() => (
                <FlatList
                  ...
                  ListHeaderComponent={() => (
                    <View style={styles.searchResult}>
                      <FText fontSize="h3">Found</FText>
                      <FText fontSize="h4">{`${restaurantData.length}`} Results</FText>
                    </View>
                  )}
